...
export function BecomeAdvertiserClient() {
        ...
        <main className="mx-auto max-w-3xl px-4 py-8 md:px-6 md:py-12">
          ...
          <div className="mb-8 text-center">
            <div className="mb-4 flex justify-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500/20 to-emerald-500/5 shadow-lg shadow-emerald-500/20">
          ...
          <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
            <Card className="border-border/50 bg-gradient-to-br from-blue-500/5 to-transparent shadow-sm">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-sm font-semibold text-foreground">Réservez des emplacements</p>
                <p className="text-xs text-muted-foreground mt-1">Accédez à notre réseau de panneaux</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/50 bg-gradient-to-br from-purple-500/5 to-transparent shadow-sm">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">Dashboard intuitif et complet</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/50 bg-gradient-to-br from-amber-500/5 to-transparent shadow-sm">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">Transactions protégées</p>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-sm">
                    Remplissez les détails de votre entreprise pour commencer
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
              ...
              {success ? (
                  <div className="flex flex-col items-center gap-6 py-8">
                    ...
                    <Button
                        ...
                        asChild
                        size="lg"
                        className="w-full max-w-sm bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-600/25"
                    >
                      <Link href="/login">
                  ...
                  <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                          ...
                          placeholder="Ex: SARL Publicité Plus"
                          required
                          className="h-11 bg-background border-border/60 focus:border-emerald-500/50 focus:ring-emerald-500/20"
                      />
                    </div>

                    {/* Champ: Numéro fiscal */}
                    <div className="space-y-2">
                      <label htmlFor="taxNumber" className="text-sm font-medium text-foreground flex items-center gap-2">
                    ...
                    <Button
                        ...
                        disabled={submitting}
                        size="lg"
                        className="h-12 w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold shadow-lg shadow-emerald-600/25 gap-2 text-base mt-2"
                    >
                      {submitting ? (
                          <>
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-muted-foreground">
              Besoin d'aide ?{" "}
              <Link href="/contact" className="font-medium text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300 underline-offset-4 hover:underline">
