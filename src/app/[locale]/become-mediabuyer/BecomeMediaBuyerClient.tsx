...
export function BecomeMediaBuyerClient() {
        ...
        <main className="mx-auto max-w-3xl px-4 py-8 md:px-6 md:py-12">
          ...
          <div className="mb-8 text-center">
            <div className="mb-4 flex justify-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500/20 to-blue-500/5 shadow-lg shadow-blue-500/20">
          ...
          <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
            <Card className="border-border/50 bg-gradient-to-br from-emerald-500/5 to-transparent shadow-sm">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-sm font-semibold text-foreground">Accès premium</p>
                <p className="text-xs text-muted-foreground mt-1">Réservez en priorité</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/50 bg-gradient-to-br from-purple-500/5 to-transparent shadow-sm">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-sm font-semibold text-foreground">Crédit flexible</p>
                <p className="text-xs text-muted-foreground mt-1">Gérez votre budget</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/50 bg-gradient-to-br from-amber-500/5 to-transparent shadow-sm">
              <CardContent className="p-4 text-center">
                ...
                <p className="text-sm font-semibold text-foreground">Réservation rapide</p>
                <p className="text-xs text-muted-foreground mt-1">En quelques clics</p>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-sm">
                    Remplissez les détails pour devenir acheteur média
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
              ...
              {success ? (
                  <div className="flex flex-col items-center gap-6 py-8">
                    ...
                    <Button
                        ...
                        asChild
                        size="lg"
                        className="w-full max-w-sm bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-600/25"
                    >
                      <Link href="/login">
                  ...
                  <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                          ...
                          placeholder="Ex: Media Corp SARL"
                          required
                          className="h-11 bg-background border-border/60 focus:border-blue-500/50 focus:ring-blue-500/20"
                      />
                    </div>

                    {/* Champ: Numéro fiscal (optionnel) */}
                    <div className="space-y-2">
                      <label htmlFor="taxId" className="text-sm font-medium text-foreground flex items-center gap-2">
                        <div className="flex h-6 w-6 items-center justify-center rounded-md bg-purple-500/10">
                          <FileText className="h-3.5 w-3.5 text-purple-600 dark:text-purple-400" />
                        </div>
                        {t("taxId")} <span className="text-xs text-muted-foreground font-normal">(optionnel)</span>
                      </label>
                      <Input
                          id="taxId"
                          name="taxId"
                    ...
                    {/* Champ: Limite de crédit */}
                    <div className="space-y-2">
                      <label htmlFor="creditLimit" className="text-sm font-medium text-foreground flex items-center gap-2">
                        <div className="flex h-6 w-6 items-center justify-center rounded-md bg-emerald-500/10">
                      ...
                      <div className="relative">
                        <Input
                            ...
                            className="h-11 bg-background border-border/60 focus:border-blue-500/50 focus:ring-blue-500/20 pr-16"
                        />
                        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5 text-xs font-medium text-muted-foreground">
                          <Wallet className="h-3.5 w-3.5" />
                          <span>XAF</span>
                        </div>
                      </div>
                      <p className="text-xs text-muted-foreground">
                        Montant maximum que vous pouvez dépenser sur la plateforme
                      </p>
                    </div>
                    ...
                    <Button
                        ...
                        disabled={submitting}
                        size="lg"
                        className="h-12 w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold shadow-lg shadow-blue-600/25 gap-2 text-base mt-2"
                    >
                      {submitting ? (
                          <>
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-muted-foreground">
              Besoin d'aide ?{" "}
              <Link href="/contact" className="font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 underline-offset-4 hover:underline">
